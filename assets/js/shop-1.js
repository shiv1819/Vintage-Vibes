...
function phone() {
    ...
    if (x % 2 == 1) {
        document.getElementById("show-phone").innerHTML = "Hide Filters";
        document.getElementById("filter").style.width = "100%";
        document.getElementById("filter").style.transform = "translateY(0px)";
        document.getElementById("filter").style.padding = "0";
    }
    if (x % 2 == 0) {
        document.getElementById("show-phone").innerHTML = "Filters";
        document.getElementById("filter").style.width = "100%";
        document.getElementById("filter").style.transform = "translateY(-1000px)";
        document.getElementById("filter").style.padding = "0";
    }
